    ...
    <div>
      ...
      {showPopper ? (
        <div ref={popperRef} style={styles.popper} {...attributes.popper} className="p-4 bg-white shadow rounded">
          <div ref={setArrowRef} style={{ ...styles.arrow, position: 'absolute', width: '10px', height: '10px' }} />
          <div className="flex flex-col space-y-3">
            <div className="flex flex-row items-center font-default text-lg cursor-pointer hover:text-emerald-400">
